...
ss_LR = ML_wtih_transform.model_LR()
...
ss_LSVC = ML_wtih_transform.model_LSVC()
...
ss_MLPC = ML_wtih_transform.model_MLPC()
...
ss_SGDC = ML_wtih_transform.model_SGDC()
